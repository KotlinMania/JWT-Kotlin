...
This repository is a Kotlin Multiplatform adaptation of the excellent auth0/java-jwt library. It keeps a very similar API surface, but is implemented in Kotlin and targets native platforms (macOS, Linux, Windows) via Kotlin/Native.
...
- Not published to Maven Central at this time; use as a source dependency (submodule/subproject or composite build).
...
Requirements
- Kotlin 2.2.x
- Kotlin Multiplatform with native targets. This project configures: macOS (arm64/x64), linuxX64, and mingwX64.
...
This fork is not published to a public registry. Add it to your build in one of the following ways.
...
Currently implemented in this fork:
...
- Android support?
  The core is common Kotlin, but this repository does not currently ship Android-specific artifacts. For Android, consider upstream libraries first.
